 ...
 */
define(["react", "react-dom", "ws", "classnames"]
    , function (React, ReactDom, ws, classNames) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button
                                ...
                                onClick={this.$sendDirective.bind(this,"stop")}><i
                                className={classNames("fa fa-stop")}></i></button>
                        </td>
                    </tr>
                );
            }
